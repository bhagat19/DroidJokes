 ...
 * on 2016-08-02 at 14:43:27 UTC 
 * Modify at your own risk.
 */

package com.example.amit.droidjokes.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://droidjokes-1470141500268.appspot.com/_ah/api/";
   ...
   * @return the request
   */
  public GetJoke getJoke(java.lang.String joke) throws java.io.IOException {
    GetJoke result = new GetJoke(joke);
    initialize(result);
    return result;
  }

  public class GetJoke extends MyApiRequest<com.example.amit.droidjokes.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "mybean/{joke}";
     ...
     * @since 1.13
     */
    protected GetJoke(java.lang.String joke) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.amit.droidjokes.backend.myApi.model.MyBean.class);
    ...
    public GetJoke setJoke(java.lang.String joke) {
      this.joke = joke;
      return this;
    }
  ...
  public class SayHi extends MyApiRequest<com.example.amit.droidjokes.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.amit.droidjokes.backend.myApi.model.MyBean.class);
